                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                ...
                                <a class="dropdown-item" href="http://jewelry/">
                                 <?=Html::beginForm(['/api/default/logout'], 'post')
                            . Html::submitButton(
            ...
            <div class="menu-list">
                <nav class="navbar navbar-expand-lg navbar-light" style="margin-bottom: 200px; padding-right: 25px">
                    ...
                    <?php $adminmenu =[
                            ...
                            ['name'=>'Delivery price', 'url'=>'delivery_price'],
                            ['name'=>'Favorites', 'url'=>'favorites'],
                            ['name'=>'Manufacturer', 'url'=>'manufacturer'],
                            ['name'=>'Metall', 'url'=>'metall'],
                            ['name'=>'Order products', 'url'=>'order_products'],
                            ['name'=>'Orders', 'url'=>'orders'],
                            ['name'=>'Product images', 'url'=>'product_images'],
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="http://jewelry/api/<?=Url::to($menu['url'])?>" aria-expanded="false" data-target="#submenu-3" aria-controls="submenu-3">
